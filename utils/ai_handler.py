...
class AIHandler:
    def __init__(self, api_key, model="google/gemini-2.0-flash-001", system_prompt=""):
        """
        ...
        try:
            ...
            for i, msg in enumerate(full_messages):
                ...
                full_messages.insert(0, {
                    "role": "system",
                    "content": "You are Coffee, a regular person in this Discord. IMPORTANT: Sound exactly like a regular person texting. Be unpredictable and imperfect. Use sentence fragments sometimes. Vary your style. Never explain yourself like an AI would. Never say 'I understand' or 'I'd be happy to help' or similar AI-like phrases. Skip greetings and sign-offs. Get straight to the point. Throw in casual opinions sometimes. Speak with personality but don't try too hard."
                })
            ...
            bot_name = "Coffee"  # Default name
            try:
                from config import BOT_CONFIG
                bot_name = BOT_CONFIG.get('name', 'Coffee')
            except ImportError:
            ...
            if len(messages) > 0 and messages[-1]['role'] == 'user':
                ...
                # Detect if user is asking Coffee to answer another person's question
            ...
            # 2. Format that info in Coffee's personality style
            if use_online:
                try:
                    ...
                    if online_response.status_code == 200:
                        ...
                        if "choices" in online_data and len(online_data["choices"]) > 0:
                            ...
                            # Step 2: Now format this in Coffee's style using the default model
                            print("Now formatting online response in Coffee's natural style...")
                            ...
                            if style_response.status_code == 200:
                                ...
                                if "choices" in style_data and len(style_data["choices"]) > 0:
                                    ...
                                    print("Successfully formatted response in Coffee's expert style")
            ...
            print("3. Verify the model 'google/gemini-2.0-flash-001' is available")
